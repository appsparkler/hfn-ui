...
function nameIsNotEmpty(user: ManualEntryUser): boolean {
...
function mobileOrEmailExistsAndAreValid(user: ManualEntryUser): boolean {
...
function isValidUser(user: ManualEntryUser): boolean {
