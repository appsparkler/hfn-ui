...
// map, pipe
"lodash/fp";
import // CheckinTypesEnum,
// IQRCheckinUser,
"widgets/BhandaraCheckin/types";
...
//   regId: tileInfo.registrationId,
//   batch: tileInfo.batch,
//   timestamp: Date.now(),
//   dormAndBerthAllocation: String(tileInfo.dormAndBerthAllocation),
...
// orderId: eventInfo.orderId,
// session:
//   eventInfo.pnrType === PNRType.FREE_ACCOMODATION
//     ? eventInfo.session
//     : undefined,
